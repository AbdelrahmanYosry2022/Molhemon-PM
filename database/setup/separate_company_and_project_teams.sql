...
-- 1. إعادة تسمية جدول team_members الحالي إلى company_team_members
ALTER TABLE team_members RENAME TO company_team_members;

-- 2. إنشاء جدول project_team_members جديد
...
-- 12. إضافة بيانات تجريبية للمشاريع
DO $$
DECLARE
...
-- 13. إنشاء دالة مساعدة للحصول على أعضاء المشروع
...
-- رسالة تأكيد
SELECT 'تم فصل أعضاء الشركة عن أعضاء المشاريع بنجاح!' as message;
