-- إصلاح جداول projects و team_members

-- 1. إصلاح جدول projects أولاً
DO $$ 
BEGIN
...
-- تحديث البيانات الموجودة في team_members
UPDATE team_members 
SET 
...
-- إضافة بيانات تجريبية للمشاريع (فقط إذا لم تكن موجودة)
...
-- إضافة أعضاء تجريبيين (فقط إذا لم تكن موجودة)
DO $$
DECLARE
...
-- رسالة تأكيد
SELECT 'تم إصلاح جداول projects و team_members بنجاح!' as message;
