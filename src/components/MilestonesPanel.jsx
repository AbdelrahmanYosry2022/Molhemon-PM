...
import { Calendar, CheckCircle2, AlertTriangle, Pencil, Trash2 } from "lucide-react";
...
export default function MilestonesPanel({ items = [], onAdd, onUpdate, onRemove }) {
  // داتا تجريبية لو مفيش items
  const demo = useMemo(
    () =>
      items.length
        ? items
        : [
            { id: "m1", title: "تسليم النسخة الأولية", date: "2025-08-10", status: "done", "note": "تم الاعتماد" },
            { id: "m2", title: "مونتاج الحلقة 1", date: "2025-08-22", status: "in-progress", note: "" },
            { id: "m3", title: "حملة الإطلاق", date: "2025-09-01", status: "at-risk", note: "بانتظار موارد إضافية" },
          ],
    [items]
  );
  ...
  return (
    <>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl border border-gray-100 p-4">
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-3 mb-3">
            ...
            <div className="flex gap-2">
              ...
              <button
                onClick={() => (onAdd ? onAdd() : console.log("Add milestone"))}
        ...
        {/* اليمين: إحصائيات + خط زمني مبسّط */}
        <div className="space-y-4">
          <div className="grid grid-cols-3 gap-2">
            <Stat label="متأخر" value={overdue} />
            <Stat label="قادمة" value={upcoming} />
            <Stat label="منجزة" value={doneCnt} />
          </div>
