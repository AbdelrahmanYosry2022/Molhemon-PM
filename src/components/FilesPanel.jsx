        ...
        : [
            {
              ...
              owner: "Ahmed Hassan",
              status: "active",
              links: ["https://files.example.com/contract_v1.pdf"],
              note: "",
            },
            {
              id: "f2",
              title: "Invoice_12.pdf",
              type: "file",
              date: "2025-08-14",
              owner: "Omar Youssef",
              status: "review",
              links: ["https://files.example.com/invoice_12.pdf"],
              note: "",
            },
            {
              id: "f3",
              title: "NDA_Signed.pdf",
              type: "contract",
              date: "2025-08-10",
              owner: "Mona Ali",
              status: "expired",
              links: ["https://files.example.com/nda.pdf"],
              note: "انتهت صلاحية العقد",
            },
            {
              id: "f4",
              ...
              owner: "Hady Nabil",
              status: "active",
              links: ["https://files.example.com/storyboard.png"],
              note: "",
            },
          ],
    [items]
